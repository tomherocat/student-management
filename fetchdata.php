...
<body background="image.jpg">
	...
	$sql1="SELECT * FROM student WHERE StudId='$regno' AND DOB='$dob'" ;
	...
	{  
		$dept=$row1["Dept"];
		$sem=$row1["Sem"];
		$sql2="SELECT * FROM tutor WHERE dept='$dept' AND sem='$sem'" ;
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8"><br><br><br>
				...
				<h4>Name of student :<?php echo "$row1[Fname]"." "."$row1[Lname]"; ?></h4><br>
					<form action="mail.php" method="post">
					  ...
					  <div class="form-group">
						...
						<input type="hidden" name="studname" value="<?php echo $row1['Fname'].' '.$row1['Lname']; ?>">
						<input type="hidden" name="regno" value="<?php echo $regno?>">

						<input type="hidden" name="tutoremail1" value="<?php echo $row2['tutor1']; ?>">	
						<input type="hidden" name="tutoremail2" value="<?php echo $row2['tutor2']; ?>">	
